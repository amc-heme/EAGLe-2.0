...
res_genes <-
  lapply(
    ...
    function(data_key){
      ...
      dataset <- read_rds(paste0(raw_data_p, datasets[[data_key]]$path))
...
con <- file("./DEres_by_dataset.yaml", open = "w")
cat(
  "# Available genes present in DE results by dataset",
  "# DO NOT MODIFY BY HAND!",
  "# Use generate_DEgene_list.R to modify.",
  sep = "\n",
  file = con
)
